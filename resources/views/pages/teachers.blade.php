...
<header>
	...
	<ul class="nav nav-pills">
  	   <input type="hidden" name="sub_id" value="{{ $arbic->id }}">
  	   <li>
  	   ...
  	   <li><a class="btn btn-primary" href="{{ url('/markteacherA') }}" role="button">صفحة العلامات</a></li>
  	   <li><a class="btn btn-primary" href="#" role="button">الرئيسية</a></li>
	</ul>
	<br>
<form action="/teacher" method="post">
     {{csrf_field()}}
	<label class="subjectname"><h4>{{$arbic->subject_name}}</h4></label>
    <input type="hidden" name="sub_id" value="{{ $arbic->id }}">
	<div class="row">
			<div class="input">
	  ...
	  <tbody>
	   @foreach($question as $questions)
	    ...
	    <tr>
	      ...
	      <td>
	      	<a href="delete\{{$questions->id}}\delete" class="btn btn-danger">حذف سؤال</a>
	      </td>
